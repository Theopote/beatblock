...
| `TimelineInteraction` | ~1816 → ~759 | 🔄 Phase 3 | Phase 1–2 helper + Phase 3：`TimelineClipDragCoordinator`/`TimelineClipDragSession`、`TimelineBoxSelectHandler`；主类保留 update 状态机 |
